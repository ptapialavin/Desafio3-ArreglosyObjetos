...
const propiedades_alquiler = [
  ...
  {
    nombre: 'Studio céntrico para profesionales',
    src: 'https://images.unsplash.com/photo-1536376072261-38c75010e6c9?auto=format&fit=crop&w=500&q=60',
    descripcion: 'Studio totalmente equipado y con excelentes conexiones de transporte.',
...
// Arma el bloque de tarjeta HTML para una propiedad
function crearTarjeta(propiedad) {
  // Texto e ícono según si fuma o no
  const fumaTexto = propiedad.smoke
    ? `<p class="text-success"><i class="fas fa-smoking"></i> Permitido fumar</p>`
    : `<p class="text-danger"><i class="fas fa-smoking-ban"></i> No se permite fumar</p>`;

  // Texto e ícono según si acepta mascotas o no
